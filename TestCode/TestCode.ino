...
//int Flex_baseline[5], Force_baseline[2];
int Flex_baseline[1], Force_baseline[2];
//int FlexMax[5], ForceMax[2]; 
int FlexMax[1], ForceMax[2];

int flexState[1] = {0};
int forceState[2] = {0, 0};
int prevforceState[2] = {0, 0};
int prevflexState[1] = {0};
/**************************************************
 **************** Autosent Keycode*****************
 **************************************************/
